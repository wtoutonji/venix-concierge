...
function venix_concierge_home_content() {
	...
	return array(
		...
		'fleet' => array(
			...
			'featured_id' => 'sclass',
			'vehicle_ids' => array( 'eclass', 'vclass', 'sprinter' ),
		...
		'media_alt' => array(
			'about'   => $copy( 'A chauffeur beside a premium vehicle in Warsaw.', 'Szofer obok luksusowego samochodu w Warszawie.' ),
			'promise' => $copy( 'A chauffeur adjusting cufflinks.', 'Szofer poprawiający spinki do mankietów.' ),
			's_class' => $copy( 'Mercedes-Benz S-Class.', 'Mercedes-Benz Klasy S.' ),
			'events'  => $copy( 'Event and delegation transportation in Warsaw.', 'Transport na wydarzenia i dla delegacji w Warszawie.' ),
		),
	);
}
