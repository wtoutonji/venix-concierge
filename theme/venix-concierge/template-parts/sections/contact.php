...
foreach ( array( 'instagram', 'facebook' ) as $venix_concierge_social_type ) {
	$venix_concierge_social_url = venix_concierge_get_site_setting_url( $venix_concierge_social_type );
	if ( '' !== $venix_concierge_social_url ) {
		$venix_concierge_contact_items[] = array(
			'type' => $venix_concierge_social_type,
			'text' => $venix_concierge_contact_content['info']['social_handles'][ $venix_concierge_social_type ],
			'url'  => $venix_concierge_social_url,
		);
	}
}
$venix_concierge_contact_icons = array(
	...
	// Reuses the same approved SVG source as the shared social-links component; only the sizing class differs.
	'instagram' => venix_concierge_get_social_icon_svg( 'instagram', 'contact-details__icon' ),
	'facebook' => venix_concierge_get_social_icon_svg( 'facebook', 'contact-details__icon' ),
);
$venix_concierge_contact_social_types = array( 'instagram', 'facebook' );
?>
